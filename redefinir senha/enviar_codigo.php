...
// INSERE O CÓDIGO NA TABELA reset_codigos
$stmt = $conn->prepare("INSERT INTO reset_codigos (pres_email, codigo, expiracao) VALUES (?, ?, ?)");
...
$stmt = $conn->prepare("SELECT * FROM reset_codigos WHERE pres_email = ? AND codigo = ? AND expiracao > NOW()");
